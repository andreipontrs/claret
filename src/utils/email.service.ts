...
export const sendVerificationEmail = async (
  ...
  await transporter.sendMail({
    from: `"Agapay" <${process.env.EMAIL_USER}>`,
    to: email,
        ...
        <table width="560" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:#d55757;padding:32px;text-align:center;">
              <span style="font-size:24px;font-weight:700;color:#ffffff;letter-spacing:1px;">Agapay</span>
            </td>
          </tr>
          <tr>
            <td style="padding:40px 48px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#555555;line-height:1.6;">
                Hi ${firstName}, thanks for signing up for Agapay. Click the button below
              ...
              <p style="margin:0 0 8px;font-size:13px;color:#888888;line-height:1.6;">
                ...
                Agapay account, you can safely ignore this email.
              </p>
          ...
          <tr>
            <td style="background:#fafafa;border-top:1px solid #eeeeee;padding:20px 48px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#aaaaaa;">© ${year} Agapay. All rights reserved.</p>
            </td>
          </tr>
        </table>
      </td>
        ...
        <table width="560" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:40px 48px 32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#555555;line-height:1.6;">
                We received a request to reset your Agapay account password.
    ...
    html: `
      <div style="font-family:Arial,sans-serif;max-width:520px;margin:auto;padding:24px;border:1px solid #e0e0e0;border-radius:10px;">
        ...
        <p style="font-size:13px;color:#999;text-align:center;">
          ...
          <strong style="color:#d55757;">Agapay Blood Bank Team</strong>
        </p>
      </div>`,
  });
}
...
export async function sendClearerImageRequestEmail({
  ...
  await transporter.sendMail({
    from: `"Agapay Blood Services" <${process.env.EMAIL_USER}>`,
    to,
            ...
            <td style="padding:40px 48px 32px;">
              ...
              <div style="background:#fff5f5;border-left:4px solid #d55757;padding:16px 20px;border-radius:6px;margin:0 0 24px;">
                ...
                <ol style="margin:0;padding-left:18px;font-size:14px;color:#555;line-height:1.8;">
                  <li>Log in to your <strong>Agapay account</strong></li>
          ...
          <tr>
            <td style="background:#fafafa;border-top:1px solid #eeeeee;padding:20px 48px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#aaaaaa;">
                © ${year} Agapay Blood Services. All rights reserved.
              </p>
            </td>
          </tr>
...
export const sendAdminCredentialsEmail = async (
  ...
  await transporter.sendMail({
    from: `"Agapay Admin System" <${process.env.EMAIL_USER}>`,
    to: email,
    subject: "Your Admin Account Credentials - Agapay",
      ...
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="background:#fafafa;border-top:1px solid #eeeeee;padding:20px 48px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#aaaaaa;">
                © ${year} Agapay Admin System. All rights reserved.
              </p>
            </td>
          </tr>
